...
const routes = {
  ...
  DOCUMENT: {
    getPath: (documentId?: string) => `/label/admin/document/${documentId || ':documentId'}`,
  },
  LOGIN: { getPath: () => '/label/login' },
  PROBLEM_REPORTS: { getPath: () => '/label/admin/main/problem-reports' },
  PRE_ASSIGN_DOCUMENTS: {
    getPath: () => '/label/admin/main/pre-assign-documents',
  },
  ...
  TO_BE_CONFIRMED_DOCUMENTS: {
    getPath: () => '/label/admin/main/to-be-confirmed-documents',
  },
  TREATED_DOCUMENTS: { getPath: () => '/label/admin/main/treated-documents' },
  UNTREATED_DOCUMENT: {
    getPath: () => '/label/admin/main/untreated-documents',
  },
};
